  ...
  <div class="base-nav-wrap">
    ...
    >
      ...
      >
        <div class="base-nav-item__content">
          <img
            ...
            src="~@/assets/images-v8/home/shouye.png"
            alt=""
          >
          <img
            class="base-nav-item__img base-nav-item__icon-night"
            src="~@/assets/images-v8/home/shouye_xz.png"
            alt=""
          >
      ...
      <li
        ...
        :key="index"
        class="base-nav-item"
        :class="[game.code, $route.name === 'game' && $route.params.id === game.code && 'base-nav-item--active', $route.name === 'lottery' && game.code === 'LOTTERY' && 'base-nav-item--active']"
      ...
      >
        <div class="base-nav-item__content">
          <img
            class="base-nav-item__img base-nav-item__icon-light"
            src="~@/assets/images-v8/home/chat.png"
            alt=""
          >
          <img
            class="base-nav-item__img base-nav-item__icon-night"
      ...
      >
        <div class="base-nav-item__content">
          <img
            class="base-nav-item__img base-nav-item__icon-light"
            src="~@/assets/images-v8/home/youhui.png"
            alt=""
          >
          <img
            class="base-nav-item__img base-nav-item__icon-night"
            src="~@/assets/images-v8/home/youhui_xz.png"
            alt=""
          >
      ...
      >
        <div class="base-nav-item__content">
          <img
            class="base-nav-item__img base-nav-item__icon-light"
            src="~@/assets/images-v8/home/app.png"
            alt=""
          >
          <img
            class="base-nav-item__img base-nav-item__icon-night"
            src="~@/assets/images-v8/home/app_xz.png"
            alt=""
          >
...
export default {
  ...
  methods: {
    ...
    async onNavItemMouseEnter(game) {
      ...
      const gameData = await this.$store.dispatch('queryQuickPlayGames', { code: game.code })
    ...
    openChat() {
      ...
      queryChatRooms({
        ...
        let { bankLevel, openLevel, passwordLevel, roomPassword, roomId } = systemChatRooms.length
          ? systemChatRooms[0]
          : chatRooms[0]
...
.base-nav-item {
  ...
  &:hover {
    ...
    .base-nav-item__icon-night {
      display: inline-block;
      filter: drop-shadow(0px 0px 3px #ffde00) drop-shadow(0px -1px 2px rgba(255, 212, 39, 0.5));
    }
  }
}
