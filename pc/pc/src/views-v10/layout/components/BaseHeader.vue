  ...
  <div class="base-header">
    <div class="container">
      ...
      <div class="base-header__content">
        ...
        <div v-if="showUnLogin" class="base-header-unlogin">
          <Input
          ...
          >
            ...
            ></Input>
            <img :src="ewmUrl" @click="refreshCheckCode" />
          </div>
          <yi-dun
            ref="yidun"
        ...
        <div v-if="showLogin" class="base-header-login">
          <Button class="ivu-btn-style--3" shape="circle">
            <span class="mt-px">{{ balance | keepDecimalOf2 }}</span>
            <span
            ...
            <img
              ...
              src="~@/assets/images-v10/home/login_Shuaxin.png"
          ...
          >
            <img
              class="object-contain"
              src="~@/assets/images-v10/home/login_geren_xz.png"
          ...
          >
            <img
              class="object-contain"
              src="~@/assets/images-v10/home/login_Deposit.png"
              style="margin-right:9px;width:20px;"
            />
            {{ $tex("充值") }}
          </div>
          ...
          >
            <img
              class="object-contain"
              src="~@/assets/images-v10/home/login_Withdrawal.png"
              style="margin-right:9px;width:20px;"
            />
            {{ $tex("提现") }}
          </div>
          <div class="base-header-login__separator"></div>
          <div
            class="pointer flex flex-no-wrap item-center"
            @click="
              $router.push({
                name: 'personalCenter',
                params: { id: 'account' },
          ...
          >
            <img
              class="object-contain"
              src="~@/assets/images-v10/home/login_Personal Center.png"
              style="margin-right:9px;width:20px;"
            />
            {{ $tex("个人中心") }}
          </div>
          ...
          <template>
            ...
            >
              <img
                class="object-contain"
                src="~@/assets/images-v10/home/login_Betting Record.png"
                style="margin-right:9px;width:20px;"
              />
              {{ $tex("投注记录") }}
            </div>
          ...
          <div class="pointer" :loading="singOutLoading" @click="signOut">
            <img
              v-if="!singOutLoading"
              class="object-contain"
              src="~@/assets/images-v10/home/login_tuichu.png"
              style="margin-right:9px;width:20px;"
            />
            <span v-if="!singOutLoading">{{ $tex("退出") }}</span>
    ...
    <try-play :is-show-try-play="play" @close-try-play="play = false">
    </try-play>
  </div>
</template>
...
export default {
  ...
  mounted() {
    const res = this.$store.getters.sysSystemConfig;
    this.arrowFree = res.ALLOW_PLAY_FOR_FREE == "0" ? false : true;
    const key = this.$store.getters.sysPlatformFlag;
    if (key == "tgdemo") {
      this.picture = "/configstatic/pc/images/logo_A.gif";
    }
  },
};
</script>
