    ...
    <div class="top">
        <div class="top-content">
            ...
            <div class="rt top-right-div"
                ...
                <a href="javascript:void(0)" class="top-a-btn top-a-yellow top-a-register">
                    <i class="iconfont icon-xiugai"></i>
                    <router-link tag="span" class="top-span-txt" to="/register">注册</router-link>
                 </a>
                <a href="javascript:void(0)" class="top-a-btn top-a-green top-a-service">
                    <i class="iconfont icon-online"></i>
                    <span class="top-span-txt" @click="openWin(servicer.url)">在线客服</span>
                </a>
            </div>
            <div class="rt top-right-div"
                v-if="!!userInfo.userCode">
                <ul>
                  <li class="userInfo">
                  ...
                  <li>
                    <span class="text">{{$tex("¥")}}{{Number(userInfo.balance).toFixed(2)}}
                      <i class="iconfont icon-refresh"
                        @mouseenter="showPopup = false"
                        @mouseleave="showPopup = false"
                        @click='refreshBalance()'
                        :class="{'turn-round':turnRound}"></i></span>
                  </li>
                  <li>
                    <Button
                    type="warning"
                  ...
                  <li>
                    <Button
                      type='primary'
                      class="deposit"
                      @click="$router.push({path:'/personalCenter/recharge'})">提现</Button>
                  </li>
                  <!-- <li>
