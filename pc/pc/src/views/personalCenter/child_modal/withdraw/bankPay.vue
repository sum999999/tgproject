      ...
      <div class="withdraw">
        ...
        <div>
          <div class="withdrawform">
            ...
            <Button
              size="small"
              v-show="lotUserBankList.length < userInfo.bankMaxnum"
              @click="toAddBank()"
...
export default {
  ...
  methods: {
    ...
    queryLotUser() {
      this.$http
        ...
        .then((response) => {
          ...
          this.$store.commit("SAVE_SYSTEM_REALNAME", this.userInfo.isRealName);
        });
    },
    ...
    toAddBank() {
      ...
      this.$router.push({
        name: "personalCenter",
        params: { id: "account", label: "bankAccount" },
      });
    },
    cancel() {
      this.bandBankFlag = false;
    ...
    init() {
      ...
      this.currentBank = this.lotUserBankList[0] || {};
