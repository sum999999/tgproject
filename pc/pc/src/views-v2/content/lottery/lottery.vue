...
.lottery-list .list li {
  ...
  border-bottom: 1px solid #30354c;
  overflow: hidden;
  cursor: pointer;
...
.lottery-list .streamer {
  ...
  background-color: #232636;
  border-top: 1px solid #31364e;
  border-bottom: 1px solid #31364e;
}
...
.lottery-list .list li .child p:first-child >>> .ivu-btn {
  border-top: 1px solid #31364e;
}
...
.lottery-list .list li .child p >>> .ivu-btn.disabled span {
  color: #999;
}
</style>
