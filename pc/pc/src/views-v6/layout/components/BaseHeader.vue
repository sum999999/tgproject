    ...
    <div class="container">
      ...
      <div class="base-header__content">
        ...
        >
          ...
          ></yi-dun>
          <Button
            class="base-header-unlogin-item"
            type="primary"
            shape="circle"
        ...
        >
          <div class="base-header-login-user">
            <div
              class="base-header-login-user__avatar"
            ...
            <span class="base-header-login-user__label usercode">{{$tex("账号")}}：</span>
            <span class="base-header-login-user__text usercode">{{userCode}}</span>
            <span class="base-header-login-user__label balance">{{$tex("余额")}}：</span>
            <span class="base-header-login-user__text balance">{{balance | keepDecimalOf2}}<span v-if="hasPermission('element.unit')">{{$tex("元")}}</span></span>
            <template v-if="hasPermission('element.coin')">
              <span class="base-header-login-user__label balance">≈</span>
              <span class="base-header-login-user__text balance">{{localBalance}}{{sysExchangeInfo.scurIcon}}</span>
              <Icon
                type="ios-loop-strong"
                class="animate__animated animate__infinite"
                :class="{
                                'animate__rotate': turnRound
                            }"
          ...
          <Button
            class="base-header-login-item"
            type="primary"
            shape="circle"
            @click="$router.push('/personalCenter/recharge')"
          >{{$tex("充值")}}</Button>
          <Button
            class="base-header-login-item"
            type="primary"
            shape="circle"
            @click="$router.push('/personalCenter/withdraw')"
          >{{$tex("提现")}}</Button>
          <Button
            class="base-header-login-item"
            type="primary"
