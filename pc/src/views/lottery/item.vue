  ...
  <div class="lobby-item">
    <div class="detal">
      ...
      <div class="results" v-else>
        <span>上期开奖</span>
        <div v-if="!hasBalls" class="zzkj">正在开奖...</div>
        <div
          class="sBall"
          v-if="hasBalls"
    ...
    <div class="bottom">
      ...
      <Button
        ...
        :class="[
          ...
          $store.getters.pageTemplate.index === 11 ? 'ivu-btn-style--11' : '',
        ]"
        @click="goBetting()"
...
export default {
  ...
  methods: {
    updatePrizeHistory(event) {
      ...
      if (this.data.lotteryId === extra.lotteryId) {
        this.balls = this.getBalls(extra.lotteryNumber);
      }
    },
    goBetting() {
...
.lobby-item .bottom .ivu-btn-style--11 {
