(function (RCS) {
	...
	var fileConfig = {
		domain: 'https://upload.qiniup.com', //upload.qiniup.com,修改为upload.qiniu.com
		fileType: RongIMLib.FILE_TYPE.IMAGE,
		getToken: function (callback) {
			 ...
			 ****************************
			 */
			RongIMLib.getInstance().getFileToken(this.fileType).then(function(data) {
				callback(data.token);
			}).catch(function(e) {
	...
	var imageStartUpload = function (_file, onSuccess, callback) {
	...
	var fileStartUpload = function (_file, onSuccess) {
		fileConfig.fileType = RongIMLib.FILE_TYPE.FILE;
		var callback = {
			onError: function (errorCode) {
				console.log(errorCode);
			},
